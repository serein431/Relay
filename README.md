...
[下载 Relay v0.1.2（macOS Apple Silicon）](https://github.com/serein431/Relay/releases/tag/v0.1.2)
...
pnpm desktop:verify src-tauri/target/release/bundle/dmg/Relay_0.1.2_aarch64.dmg
```
...
pnpm desktop:verify:release src-tauri/target/release/bundle/dmg/Relay_0.1.2_aarch64.dmg
```
